...
This privacy policy applies to the Geometry Space Shooter app (hereby referred to as "Application") for mobile devices that was created by Eduardo Kumagai Rocha (hereby referred to as "Service Provider").

The Application is an independently-made Unity game for Android, available on the App Store. It uses the Unity Ads SDK to display advertisements to the player.
